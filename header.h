...
/*
* функция input_library - предлагает пользователю заполнить библиотеку
* Возвращает заполненную библиотеку
*/
library_t input_library(void);
/*
* функция new_library - добавляет новую библиотеку в базу данных
* Память для новой структуры выделяется в массиве
* Функция возвращает целое число - код ошибки
* ptr_arr - указатель на массив структур
* library - новая библиотека
* ptr_size - указатель на размер массива
*/
int new_library(library_t**, library_t, int*);
/*
...
* Возвращает целое число - код ошибки
* ptr_arr - указатель на массив структур
* ptr_size - указаетль на размер массива
* library_number - номер библиотеки
*/
int delete_library(library_t*,int*, int);
/*
...
* num - выбранная цифра
*/
int edit_library(library_t*, int, int);
/*
...
/*
* Функция show_all - выводит все библиотеки из массива в консоль
...
/*
* Функция put_term - возвращает введённую строку
*/
char* put_term(void);
/*
* Функция search - обращается к функции поиска, которую выбрал пользователь
* Возвращает указатель на массив найденных библиотек
* ptr_arr - указатель на массив структур
* size - размер базы данных
* sizeNumber - цифра, введённая пользователем, соответствующая выбору признака поиска
* ptr_arr_size - указатель на размер массива найденных библиотек
*/
library_t* search(library_t*, int, int, int*);
/*
* Функция search_libraryLanguage - совершает поиск по массиву структур, соответствующих введённому пользователем языку программирования
* Возвращает указатель на массив найденых библиотек
* ptr_arr - указатель на массив структур
* ptr_size - указатель на размер базы данных
*/
library_t* search_libraryLanguage(library_t*,int*);
/*
* Функция search_libraryName - совершает поиск по массиву структур, соответствующих введённому пользователем названию библиотеки
* Возвращает указатель на массив найденых библиотек
* ptr_arr - указатель на массив структур
* ptr_size - указатель на размер базы данных
*/
...
/*
* Функция sort - обращается к функции сортировки, соответсвующей введённой цифре
* Возвращает указатель на массив структур
* ptr_arr - указатель на массив структур
* size - размер базы данных
* sortNumber - цифра выбранной сортировки
*/
library_t* sort(library_t*, int, int);
/*
...
* size - размер базы данных
*/
library_t* init_list(library_t*, int);
/*
